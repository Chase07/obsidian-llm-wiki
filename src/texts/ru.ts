...
export const RU_TEXTS = {
    ...
    ingestReportEmbeddedImages: 'Встроенные изображения: найдено {discovered}, в очереди {queued}, отправлено {sent}, проанализировано {analyzed}; пакетов {packages}, первых кадров GIF преобразовано {gifs}, ошибок пакетов: {failed}',
    ingestReportEmbeddedImageSkipped: 'Пропущенные встроенные изображения',
    embeddedImagesVisionUnsupported: 'Этот endpoint отклонил анализ изображений. Текстовая обработка продолжится; выберите модель с поддержкой зрения или отключите анализ встроенных изображений.',
    ...
    analyzeEmbeddedImagesName: 'Анализировать встроенные изображения при обработке Markdown',
    analyzeEmbeddedImagesDesc: 'По умолчанию выключено. Анализирует все подходящие локальные изображения пакетами до 20 МиБ; каждое изображение ограничено 10 МиБ. Удалённые изображения никогда не загружаются.',
