...
export const RU_TEXTS = {
    ...
    analyzeEmbeddedImagesDesc: 'По умолчанию выключено. Отправляет с запросом извлечения Markdown до 10 локальных изображений по 10 МиБ каждое. Удалённые изображения никогда не загружаются.',
